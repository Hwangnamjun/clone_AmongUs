...
{
    public PlayerColorList playerColor;
    ...
    public void SetFloatingCrew(Sprite sprite, PlayerColorList playerColor, Vector3 direction, float floatingSpeed, float rotateSpeed, float size)
    {
